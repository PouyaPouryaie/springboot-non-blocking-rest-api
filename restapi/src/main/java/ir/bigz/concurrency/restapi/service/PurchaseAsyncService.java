...
public class PurchaseAsyncService {
    ...
    public PurchaseAsyncService(OrderRestClient orderRestClient, PaymentRestClient paymentRestClient) {
    ...
    public void updatePurchase(Purchase purchase) {
        ...
        CompletableFuture.allOf(
                CompletableFuture.supplyAsync(() -> paymentRestClient.getPayment(purchase.getOrderId()))
                        .thenAccept(payment -> {
                ...
                CompletableFuture.supplyAsync(() -> orderRestClient.getPrice(purchase.getOrderId()))
...
//        List<CompletableFuture<Void>> futurePurchaseList = new ArrayList<>();
        ...
        Collection<List<Purchase>> purchaseGroupList = purchases.stream()
                .collect(Collectors.groupingBy(purchase -> purchase.getOrderId() / 50)).values();
